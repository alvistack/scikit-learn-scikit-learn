...
BuildRequires: python3-joblib >= 1.4.0
BuildRequires: python3-narwhals >= 2.0.1
BuildRequires: python3-meson-python >= 0.15.0
BuildRequires: python3-numpy >= 1.24.1
BuildRequires: python3-numpy-f2py >= 1.24.1
BuildRequires: python3-pip
BuildRequires: python3-scipy >= 1.10.0
BuildRequires: python3-threadpoolctl >= 3.5.0
...
Summary: Python module for machine learning
Requires: python3
Requires: python3-joblib >= 1.4.0
Requires: python3-narwhals >= 2.0.1
Requires: python3-numpy >= 1.24.1
Requires: python3-scipy >= 1.10.0
Requires: python3-threadpoolctl >= 3.5.0
