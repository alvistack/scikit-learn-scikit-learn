...
BuildRequires: python3-numpy >= 1.22.0
BuildRequires: python3-numpy-f2py >= 1.22.0
BuildRequires: python3-pip
BuildRequires: python3-scipy >= 1.8.0
...
Summary: Python module for machine learning
Requires: python3
Requires: python3-joblib >= 1.2.0
Requires: python3-numpy >= 1.22.0
Requires: python3-scipy >= 1.8.0
Requires: python3-threadpoolctl >= 3.1.0
